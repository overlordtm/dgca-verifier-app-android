...
package si.vakcin.pct.android.di
...
import si.vakcin.pct.android.data.local.countries.CountriesDao
import si.vakcin.pct.android.data.local.countries.DefaultCountriesLocalDataSource
import si.vakcin.pct.android.data.local.rules.DefaultRulesLocalDataSource
import si.vakcin.pct.android.data.local.rules.EngineDatabase
import si.vakcin.pct.android.data.local.rules.RulesDao
import si.vakcin.pct.android.data.local.valuesets.DefaultValueSetsLocalDataSource
import si.vakcin.pct.android.data.local.valuesets.ValueSetsDao
import si.vakcin.pct.android.data.remote.countries.CountriesApiService
import si.vakcin.pct.android.data.remote.countries.DefaultCountriesRemoteDataSource
import si.vakcin.pct.android.data.remote.rules.DefaultRulesRemoteDataSource
import si.vakcin.pct.android.data.remote.rules.RulesApiService
import si.vakcin.pct.android.data.remote.valuesets.DefaultValueSetsRemoteDataSource
import si.vakcin.pct.android.data.remote.valuesets.ValueSetsApiService
